...
public class Challenge extends TimeStamp {
    ...
    public void setChallenge (String title, String content, String image, Category category, ConditionStatus conditionStatus, LocalDateTime startTime, LocalDateTime endTime) {
        this.title = title;
